...
<head>
    ...
    <script src="js/components/SortableList.js"></script>
    <script src="js/compare_highchart.js"></script>
    ...
    <div class="container-full container well">
        <div class="row">
            <div class="col-md-4 container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <input type="text" placeholder='Title' id="chart_title" class="form-control" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <input type="button" class="form-control btn btn-primary" id="add_chart" value="Add" />
                    </div>

                    <div class="col-md-4">
                        <input type="button" class="form-control btn btn-danger" id="reset_chart" value="Reset" />
                    </div>
                </div> <!-- .row -->

                <div class="charts_list row">
            ...
            <div class="col-md-4 container">
                ...
                <div class="row">
                    <div class="daterange col-md-6">
                        <input name="daterange1" class="form-control" value="2013-01-01 - 2014-12-30">
                    </div>
                    <div class="daterange col-md-6">
                        <input name="daterange2" class="form-control" value="2013-01-01 - 2014-12-30">
                    </div>
                </div>
